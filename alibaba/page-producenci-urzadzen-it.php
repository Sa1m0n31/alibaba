        ...
        <div class="landing__main__right landing__main__right--page2">
            <div class="landing--page__points">
                ...
                <span class="landing--page__points__item">
                        <img class="img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/check-background.png'; ?>" alt="it" />
                        <span>
                            CCTV, alarmy, Kontrola dostępu
                        </span>
                    </span>
                <span class="landing--page__points__item">
                        <img class="img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/check-background.png'; ?>" alt="it" />
                        <span>
                            automaty self service (paczkowe i inne urządzenia automatyzujące sprzedaż np. butlomaty)
                        </span>
                    </span>
                <span class="landing--page__points__item">
                        <img class="img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/check-background.png'; ?>" alt="it" />
    ...
    <div class="landing__after landing__after--page2 w">
        <div class="flex">
            <figure class="landing__after__img">
                <img class="img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/it-1.png'; ?>" alt="it" />
            </figure>
            <figure class="landing__after__img">
                <img class="img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/it-1.png'; ?>" alt="it" />
            </figure>
