<?php
/**
 * alibaba functions and definitions
 *
 ...
 */
function alibaba_setup() {
    /*
        * Make theme available for translation.
        * Translations can be filed in the /languages/ directory.
        * If you're building a theme based on alibaba, use a find and replace
        * to change 'alibaba' to the name of your theme in all the template files.
        */
    load_theme_textdomain( 'alibaba', get_template_directory() . '/languages' );
    ...
    register_nav_menus(
        array(
            'menu-1' => esc_html__( 'Primary', 'alibaba' ),
        )
    );
    ...
    add_theme_support(
        'custom-background',
        apply_filters(
            'alibaba_custom_background_args',
            array(
...
add_action( 'after_setup_theme', 'alibaba_setup' );
 ...
 */
function alibaba_content_width() {
    $GLOBALS['content_width'] = apply_filters( 'alibaba_content_width', 640 );
}
add_action( 'after_setup_theme', 'alibaba_content_width', 0 );
 ...
 */
function alibaba_widgets_init() {
    register_sidebar(
        array(
            'name'          => esc_html__( 'Sidebar', 'alibaba' ),
            'id'            => 'sidebar-1',
            'description'   => esc_html__( 'Add widgets here.', 'alibaba' ),
...
add_action( 'widgets_init', 'alibaba_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function alibaba_scripts() {
    wp_enqueue_style( 'alibaba-style', get_stylesheet_uri() . '?n=11', array(), _S_VERSION );
...
add_action( 'wp_enqueue_scripts', 'alibaba_scripts' );
